...
st.write(round(produced,2),'produced','\t',round(ic_da,2),'intracellular',round(packaged,2),'packaged','\t',round(iv_da,2),'intravesicular')
st.write(round(released,2),'released', '\t',round(ec_da,2),'extracelllular')
st.write(round(l_receptors,2), 'D2l','\t',round(s_receptors,2),'D2s','\t',round(da_receptors,2),'DA receptors',round(da_tone,2),'tone')
...
plt.scatter(time[1000:cycles],horizontal, color = 'green',alpha = .1,s = 1)
...
plt.scatter(time[1000:cycles],recept_list[1000:cycles], color = 'red',s=1)
plt.scatter(time[1000:cycles],toneset[1000:cycles], color = 'cyan',s=1)
